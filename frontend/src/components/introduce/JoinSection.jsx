  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-24">
        <div className="grid grid-cols-5 gap-3 items-center mb-10 px-4 md:px-7 max-w-6xl mx-auto">
          <div className="col-span-3 flex flex-col items-center">
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white to-white bg-clip-text text-transparent">
              加入我们
            </h1>
          </div>
          <div className="col-span-2 flex items-start gap-4 md:pl-0">
            <img src="/title.png" alt="加入我们图片" className="w-full" />
            <div className="flex flex-col gap-3 items-center">
              <div className="w-14 h-14 rounded-full overflow-hidden shadow-lg bg-blue-500  ">
                <img
                  src="/favicon.ico"
                  alt="学校"
        ...
        <div className="max-w-3xl mx-auto mb-12">
          ...
          `}</style>
          <p className="text-lg mb-4 text-white paragraph-spacing">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div
            className={`rounded-lg shadow-lg p-6 bg-opacity-90 dark:bg-opacity-90`}
            style={{
          ...
          >
            ...
            <div className="flex items-center mb-3">
              ...
              <a
                href="mailto:leader@example.com"
                className="hover:text-blue-400 transition"
              >
                Email: mesonoxian@hrbeu.edu.cn
              </a>
            </div>
