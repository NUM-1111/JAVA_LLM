    ...
    >
      <div className="container mx-auto px-4 py-8 h-full">
        ...
        <div className="w-full h-full">
          <div className="grid grid-cols-12 gap-4 auto-rows-auto mt-8">
            <div
              className="col-span-12 md:col-span-6 bg-opacity-90 dark:bg-opacity-90 rounded-lg shadow-lg p-4"
              paragraph-spacing
              style={{
            ...
            >
              ...
              <ul className="list-inside">
                <li className="mb-2">
                  ...
                  <strong>智能对话：</strong>{" "}
                  提供基于DeepSeek满参数大模型的高质量对话服务，解答学术、生活等多方面问题
                </li>
                <li className="mb-2">
            ...
            >
              ...
              <ul className="list-inside">
                <li className="mb-2">
                  ...
                  <strong>强大算力：</strong>{" "}
                  依托智能科学与工程学院高性能计算集群，提供稳定、高效的算力支持
                </li>
                <li className="mb-2">
                  <span role="img" aria-label="robot">
                    🔑
                ...
                <li className="mb-2">
                  ...
                  <strong>全场景支持：</strong>{" "}
                  覆盖教学、科研、学习和生活等多场景应用，打造智慧校园新体验
                </li>
              </ul>
            </div>

            <div
              className="col-span-12 md:col-span-8 bg-opacity-90 dark:bg-opacity-90 rounded-lg shadow-lg p-4"
              paragraph-spacing
              style={{
                backgroundColor: darkMode
                  ? "rgba(44, 55, 74, 0.9)"
            ...
            <div
              className="col-span-12 md:col-span-4 bg-opacity-90 dark:bg-opacity-90 rounded-lg shadow-lg p-4"
              paragraph-spacing
              style={{
                backgroundColor: darkMode
                  ? "rgba(51, 65, 85, 0.9)"
              ...
              <div className="flex items-start mb-5">
                <div className="ml-2">
                  <div className="flex items-center">
                    ...
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-white ml-8">
                      QwQ
                    </h2>
                    <span className="text-sm text-gray-700 dark:text-gray-300 ml-2">
                      规划模型
