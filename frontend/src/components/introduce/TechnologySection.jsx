  ...
  return (
    ...
    >
      <div className="mt-0 mb-0 py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
        ...
        <div
          className="col-span-12 md:col-span-8 bg-opacity-90 rounded-lg p-4 border border-gray-300"
          paragraph-spacing
        ...
        >
          <div className="flex items-center justify-start gap-1">
            ...
            <p className="text-blue-700">
              <strong>
                平台采用全链路MIT开源技术栈，从基础设施到应用层均使用开放、透明的开源组件，确保系统安全可控、自主可控。
              </strong>{" "}
            </p>
          </div>
        ...
        <div className="gap-x-3 gap-y-0 pt-3 grid grid-cols-1  lg:grid-cols-4 ">
          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg ">
            ...
            >
              <div className="flex ">
                ...
                <span className=" ml-1 text-blue-700 font-bold mt-1">
                  Blazor Server
                </span>
              </div>
            </a>
            <p className="text-sm">
              基于 .NET 的全栈 Web 框架，使用 C# 代替 JavaScript 构建交互式 Web
              应用，通过 SignalR 实现服务器端实时通信。
            </p>
          </div>

          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
            <a
              href="https://www.blazor.zone/"
              target="_blank"
              className="flex flex-col"
            >
              <div className="flex ">
                <img
                  src="/bootstrapblazor-icon.png"
                  alt="BootstrapBlazor"
            ...
            <p className="text-sm">
              基于 Bootstrap 的 Blazor UI 组件库，提供丰富的企业级 UI 组件和现代
              Web 交互体验。
            </p>
          </div>
          ...
          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
            ...
            <p className="text-sm">
              微软开源的 AI 编排框架，支持 LLM
              集成、提示工程、语义函数和智能管道，简化 AI 应用开发。
            </p>
          </div>
          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
            <a
            ...
            <p className="text-sm">
              使用开源跨平台的 .NET 框架，提供高性能、跨平台的运行环境。
            </p>
          </div>
          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
            <a
              href="https://microsoft.github.io/reverse-proxy/"
              target="_blank"
              className="flex flex-col items-center"
            >
              <div className="flex ">
            ...
            <p className="text-sm">
              微软开源的反向代理框架，用于负载均衡和请求转发，实现多GPU节点的灵活调度。
            </p>
          </div>
          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
            <a
              href="https://202.118.184.207/#"
              target="_blank"
              className="flex flex-col items-center"
            >
              <div className="flex ">
          ...
          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
            ...
            <p className="text-sm">
              微软开源的分布式应用存储服务，提供高性能、高可用的数据存储能力。
            </p>
          </div>
          <div className="mx-0 mb-0 flex flex-col items-start py-5 px-4 sm:px-6 lg:px-8 m-[3vh] border border-gray-500 rounded-lg">
            <a
            ...
            <p className="text-sm">
              容器化平台，用于应用程序的构建、部署和运行，确保在不同环境中的一致性。
            </p>
          </div>
