      ...
      <div className="flex flex-row items-center justify-center w-4/5 z-10 bg-gray-200">
        <div className="absolute right-4 top-3 h-8 flex space-x-2">
          ...
          <div className="flex flex-row gap-2">
            {/* 登录按钮 */}
            <button
              className="px-3 py-1 bg-blue-500 text-white rounded-2xl hover:bg-blue-400 transition "
            ...
            {/* 注册按钮 */}
            <button
              className="px-3 py-1 bg-white text-black rounded-2xl hover:bg-slate-100 transition hidden md:block"
